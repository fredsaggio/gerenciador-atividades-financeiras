...
import os
print("Bem-vindo ao GAF, seu gerenciador de atividades financeiras e amigo.",
      "Me diga o que deseja fazer e farei o trabalho para poupar seu tempo.",
      "Digite 1, 2 ou 3 para: ","1. Saldo restante após pagamentos", "2. Mapa para gerenciar finanças", "3. Simulações de investimento",
      "4. Financiamento", "5. Sair", sep="\n")
while True:
    entrada = input("Qual opção você irá escolher?: ")
    try:
        funcao = int(entrada)
    except ValueError:
